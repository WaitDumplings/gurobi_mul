...
def write_checkpoint_solution(instance_id: str, snapshot: dict[str, Any], checkpoint_dir: Path) -> str:
    ...
    solution = ClassicalVRPSolution(
        ...
        solver_name="gurobi_vrptw_arcflow",
...
def main(argv: list[str] | None = None) -> None:
    parser = argparse.ArgumentParser(description="Run exact Gurobi VRPTW solver on classical_dataset_v1 pickle bundles.")
