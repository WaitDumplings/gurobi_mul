...
DEFAULT_DATASET_ROOT = SCRIPT_ROOT.parents[1] / "classical_dataset_v1" / "vrptw" / "dataset"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run a multiprocessing Gurobi shard for Geo-VRPTW-v1.")
